...
const FeaturesComponent = () => {
  return (
    <Features className='row'>
        ...
        <p className='text-center mt-3 mb-5'>When a consultant takes a new project, they typically start by doing an in-depth analysis of their client's business goals and objectives.</p>

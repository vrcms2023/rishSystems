...
class Projects(models.Model):
        ...
        percentValue = models.CharField(max_length=50, null=True)
        isActive = models.BooleanField(default=False)
        publish = models.BooleanField(default=False)
        aboutstitle= models.CharField(max_length=50, null=True)
        aboutussubtitle= models.CharField(max_length=50, null=True)
        imageDescription= models.CharField(max_length=1000, null=True)
